...
Route::group(['middleware' => ['checkTeacherRole', 'auth:sanctum']], function () {
    ...
    Route::patch('/course_update/{id}', [CourseController::class, 'update']);
    ...
    Route::patch('/section_update/{id}', [SectionController::class, 'update']);
...
Route::group(['middleware' => ['checkAdminRole', 'auth:sanctum']], function () {
    ...
    Route::patch('/skill_update/{id}', [SkillsController::class, 'update']);
    Route::delete('/skill_destroy/{id}', [SkillsController::class, 'destroy']);
    Route::post('/category_store', [CategoryController::class, 'store']);
    Route::patch('/category_update/{id}', [CategoryController::class, 'update']);
...
Route::group(['middleware' => ['auth:sanctum']], function () {
    ...
    Route::patch('/q_a_update/{id}', [Q_aController::class, 'update']);
    ...
    Route::patch('/review_update/{review_id}', [ReviewController::class, 'update']);

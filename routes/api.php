...
Route::group(['middleware' => ['checkTeacherRole', 'auth:sanctum']], function () {
    ...
    Route::post('/section_update', [SectionController::class, 'update']);
    Route::post('/section_destroy', [SectionController::class, 'destroy']);
    ...
    Route::post('/lesson_update', [LessonController::class, 'update']);
    Route::post('/lesson_destroy', [LessonController::class, 'destroy']);
...
Route::group(['middleware' => ['checkStudentRole', 'auth:sanctum']], function () {
    ...
    Route::post('/enrollment_store', [EnrollmentController::class, 'store']);
...
Route::post('/lesson_index', [LessonController::class, 'index']);
Route::post('/lesson_show', [LessonController::class, 'show']);
Route::post('/enrollment_show', [EnrollmentController::class, 'show']);
